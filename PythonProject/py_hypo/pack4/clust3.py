'''======================================
비지도 학습의 비 계층적 군집분석 : k-means
k의 갯수를 정해주는 것이 가장 큰 관건
======================================'''

import matplotlib.pyplot as plt
from sklearn.datasets import make_blobs  # clustering 연습용
...
plt.scatter(x[pred == 1 , 0], x[pred == 1, 1], c='yellow', marker='o', s=50, label='cluster2')
plt.scatter(x[pred == 2 , 0], x[pred == 2, 1], c='blue', marker='o', s=50, label='cluster3')
...
# 데이터 X와 X를 임의의 클러스터 개수로 계산한 k-means 결과인 y_km을 인자로 받아 
# 각 클러스터에 속하는 데이터의 실루엣 계수값을 수평 막대 그래프로 그려주는 함수를 작성함.
