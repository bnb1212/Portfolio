...
def d(n):
    ...
    tot = n_thousand + n_hundred + n_ten + n_one 
    return n+tot

num_list = range(1, 10000)
have_selfnum_list =[]

for i in range(1, 10000): 
    have_selfnum_list.append(d(i))
    
num_list = set(num_list)
have_selfnum_list = set(have_selfnum_list)

ans = num_list - have_selfnum_list
ans = list(ans)
