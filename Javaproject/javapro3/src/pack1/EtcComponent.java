...
//Choice
		...
		pn1.add(new Label("Answer is already defined", Label.RIGHT));
...
//Checkbox
		...
		chk3 = new Checkbox("america", false);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		else if (e.getItem().equals("노랑"))
			c = Color.yellow;

		else if (e.getItem().equals("파랑"))
			c = Color.blue;

		else if (e.getItem().equals("검정"))
			c = Color.black;
